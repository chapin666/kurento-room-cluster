        ...
        if (this.isWeb()) {
            ...
            builder.buildAsync(new Continuation<WebRtcEndpoint>() {
                ...
                public void onSuccess(WebRtcEndpoint result) throws Exception {
                    ...
                    webEndpoint.setMaxVideoRecvBandwidth(350);
                    webEndpoint.setMinVideoRecvBandwidth(100);
                    webEndpoint.setMaxVideoSendBandwidth(350);
                    webEndpoint.setMinVideoSendBandwidth(100);
