...
import tv.lycam.sdk.endpoint.PublisherEndpoint;
import tv.lycam.sdk.endpoint.SdpType;
import tv.lycam.sdk.endpoint.SubscriberEndpoint;
...
public class Participant {
    ...
    public String preparePublishConnection() {
        log.info(
                "USER {}: Request to publish video in room {} by " + "initiating connection from sdk",
